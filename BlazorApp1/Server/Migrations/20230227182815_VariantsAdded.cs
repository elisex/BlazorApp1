...
{
    /// <inheritdoc />
    public partial class VariantsAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 2, 1, 99000m, 97990m },
                    { 2, 2, 81700m, 81700m },
                    { 2, 3, 3100000m, 3100000m },
                    { 2, 4, 30.99m, 27.99m },
                    { 3, 1, 129990m, 109990m },
                    { 3, 2, 95000m, 87110m },
                    { 3, 3, 3600000m, 3600000m },
                    { 3, 4, 40.99m, 34.99m }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "OriginalPrice", "Price" },
                values: new object[] { 195.95m, 95.95m });
